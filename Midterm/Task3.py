...
# დაწერეთ პროგრამა, რომელსაც არგუმენტად გადაეცემა საცავის სახელი.
# პროგრამამ უნდა შეამოწმოს საცავი არსებობს თუ არა. თუ არსებობს უნდა
# დაწეროს რომ საცავი უკვე არსებობს, თუ არ არსებობს უნდა შექმნას ის.
s3 = boto3.client("s3")
